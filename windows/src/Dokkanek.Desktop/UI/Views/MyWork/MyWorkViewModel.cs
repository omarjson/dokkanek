...
namespace Dokkanek.Desktop.UI.Views.MyWork
{{
    // TODO: swap to the dedicated domain service for this module.
    public class MyWorkViewModel : ObservableObject
    {{
        ...
        public MyWorkViewModel(ISaleService svc, ISessionService session)
        {{
            _svc = svc;
            _session = session;
