...
namespace Dokkanek.Desktop.UI.Views.Permissions
{{
    // TODO: swap to the dedicated domain service for this module.
    public class PermissionsViewModel : ObservableObject
    {{
        ...
        public PermissionsViewModel(ISaleService svc, ISessionService session)
        {{
            _svc = svc;
            _session = session;
