...
namespace Dokkanek.Desktop.UI.Views.Stickers
{{
    // TODO: swap to the dedicated domain service for this module.
    public class StickersViewModel : ObservableObject
    {{
        ...
        public StickersViewModel(IProductService svc, ISessionService session)
        {{
            _svc = svc;
            _session = session;
